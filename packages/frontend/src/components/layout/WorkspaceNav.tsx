    ...
    <header className="border-b border-border/60 bg-card/90 shadow-sm">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6">
        ...
        <button
          type="button"
          onClick={signOut}
          className="hidden items-center gap-2 rounded-2xl border border-border/60 px-4 py-2 text-xs font-semibold text-foreground hover:border-primary/30 lg:inline-flex"
        >
